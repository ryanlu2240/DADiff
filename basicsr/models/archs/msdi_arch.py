...
class msdi_net(nn.Module):
    ...
    def __init__(self, in_chn=3, wf=64, depth=5, relu_slope=0.2, hin_position_left=0, hin_position_right=4):
        ...
        self.prior_upsampling.load_state_dict(torch.load('/eva_data1/shlu2240/checkpoints/LD/celeba_x4_seperate/prior_upsample_42000.pth'), strict=False)

        self.net_prior = ConvEncoder()
        self.net_prior.load_state_dict(torch.load('/eva_data1/shlu2240/checkpoints/LD/celeba_x4_seperate/net_E_42000.pth'), strict=False)
        ...
        # self.generator.load_state_dict(torch.load('/eva_data1/shlu2240/checkpoints/LD/celeba_x4_seperate/generator_42000.pth'), strict=False)
